...
public class EnglishLemmaTokenizer extends TokenStream {
    ...
    public static void main(String[] args) {
       // EnglishLemmaTokenizer englishLemmaTokenizer = new EnglishLemmaTokenizer();
    ...
    public final boolean incrementToken() throws IOException {
        if (lemmaNext) {
            ...
            termAtt.setLength( Morphology.stemStatic(form, tag).word().length());
           // termAtt.setTermBuffer(Morphology.stemStatic(form, tag).word());
            ...
            termAtt.setLength(currentWord.word().length());
        }
