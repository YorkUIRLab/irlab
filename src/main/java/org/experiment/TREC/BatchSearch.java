...
public class BatchSearch {
	...
	public static void main(String[] args) throws Exception {
		...
		String queries = "/home/sonic/Dev/WT2G/topics/topics.title";
        ...
        PrintWriter writer = new PrintWriter("test-data/wt2g.out", "UTF-8");
		...
		while (true) {
            ...
            System.out.println("Query:  " + pair[1]);
			doBatchSearch(in, searcher, pair[0], query, simstring, writer);
		}
		reader.close();
        writer.close();
	}
	 ...
	 */
	public static void doBatchSearch(BufferedReader in, IndexSearcher searcher, String qid, Query query, String runtag, PrintWriter writer)
			throws IOException {
		...
		for (int i = start; i < end; i++) {
            ...
            writer.println(qid+" Q0 "+docno+" "+i+" "+hits[i].score+" "+runtag);
		}
