...
public class IndexWikipedia {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FSDirectory dir = FSDirectory.open(Paths.get(args[1]));

        StandardAnalyzer analyzer = new StandardAnalyzer();// default stop words
        ...
        System.out.println("Index should be located at " + dir.getDirectory());
        docMaker.close();
        indexWriter.close();
    }

    private static void printUsage() {
        System.out.println("Usage: java -cp <...> me.lemire.lucene.IndexDump somewikipediadump.xml.gz outputdir");
    }
