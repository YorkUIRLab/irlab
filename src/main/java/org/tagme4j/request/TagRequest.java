...
public class TagRequest extends TagMeRequest<TagResponse> {
     ...
     * Anyway recall that TagMeQueryExpander's strength relies in its ability to annotate short texts
     ...
     * optional
     *
     * Enable the special HTMLParser for Twitter messages.
     * This HTMLParser has been designed to better handle with usual
     ...
     *
     * @param tweet enable the special HTMLParser for Twitter messages
     * @return
     */
     ...
     * including those ones that TagMeQueryExpander was not able to annotate with an entity.
     ...
     * optional
     *
     * TagMeQueryExpander is designed to annote short text but it resulted competitive on long texts too.
     * When annotating long texts, TagMeQueryExpander processes just a limited portion of the input text at once,
     ...
     * If you want to disable this mechanism and force TagMeQueryExpander to always process
